...
const tableau1 = [  {id:1, image: 'img/huile d olive.png', nom:'huile d olive', ingredient: 1,},
...
tableau1.forEach(element => {
    ...
    // creation d'une balise li ou th
    let creerListe= document.createElement("th")
    // creation du bouton 
...
listes.push(element)
const index = tableau1.indexOf(element)
console.log(index)
tableau1.splice(index,1)
console.log(tableau1)


//afficher les ingredients selectionnés et le resultat recette (tableau 2 et 3)  
        ...
        function listeTableau2(){
            ...
            <li class="list-group-item">
                    <div class="row">
                            ...
                            <div class="col"> 
                                <span class="float-right" ><button " onclick="removeName()"  class="btn btn-danger">X</button></span>
                            </div>
                    </div>                    
            </li>
            `     
...
console.log(listeTableau2)

//////////////////////////////////////////////////////////tableau 3//////////////////////////////////////////////////////////

    function listeTableau3(){
        let pizzas = [
        {id :1, nom:"Croque monsieur", ingredients : [1,2,3]},
        {id :2, nom:"Burger", ingredients : [1]},
        {id :3, nom:"salade de riz", ingredients : [2,1]},
        {id :4, nom:"risotto", ingredients : [3]},
        {id :5, nom:"Gateau au chocolat", ingredients : [1,3]}
    ];
    // ... copie le tableau d'origine avec des nouvelles conditions
